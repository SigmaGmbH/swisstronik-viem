...
describe("createSwisstronikClient Tests", () => {
  ...
  it("Should call contract on testnet with encrypted data", async () => {
  ...
  it("Should estimate gas for tx on testnet with encrypted data", async () => {
  ...
  it("Should send tx on testnet with encrypted data", async () => {
